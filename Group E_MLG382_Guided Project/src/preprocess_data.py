...
if __name__ == "__main__":
    ...
    # Drop unnecessary columns (e.g., label encodings or IDs if present)
    drop_cols = [col for col in train_df.columns if col.endswith("_label") or "id" in col.lower()]
    ...
    print("Data cleaning complete. Cleaned files saved to 'data/'")
